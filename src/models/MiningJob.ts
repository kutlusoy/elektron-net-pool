...
// the commitment can never pick these up instead of the real one. Same magic
// bytes as elektron-net-ppool, so elektron-net-mempool's pool-agnostic,
// content-addressed parser works unmodified for this pool too.
