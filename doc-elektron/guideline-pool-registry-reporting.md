...
1. Exact endpoint paths/payload shapes, to be agreed with `elektron-net-mempool` and kept identical to `elektron-net-ppool`'s implementation.
...
- [ ] Verified byte-identical behavior with `elektron-net-ppool`'s implementation
